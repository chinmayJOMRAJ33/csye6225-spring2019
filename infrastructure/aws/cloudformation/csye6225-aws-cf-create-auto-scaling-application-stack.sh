...
SSLCert=$(aws acm list-certificates  --query 'CertificateSummaryList[1].CertificateArn' --output text)
echo $SSLCert

SSLCert2=$(aws acm list-certificates  --query 'CertificateSummaryList[0].CertificateArn' --output text)
echo "$SSLCert2"
